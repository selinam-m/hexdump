...
In cases where no file is provided, the program reads user input from the stdin stream and processes it to print the dump of bytes entered.
...
2. The offset has 8 hexadecimal digits: it can read up to 4GB of data then start to misbehave.
